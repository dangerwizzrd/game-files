...
const simpleWeapons = [
  ...
  { name: "mace", meleeDamage: 3, type: "simple weapon" },
  { name: "staff", meleeDamage: 2, type: "simple weapon" },
  { name: "handaxe", meleeDamage: 3, type: "simple weapon" },
  { name: "shortsword", meleeDamage: 3, type: "simple weapon" },
  {
    name: "stick",
    meleeDamage: 1,
    type: "simple weapon",
...
const martialWeapons = [
  ...
  { name: "battleaxe", meleeDamage: 5, type: "martial weapon" },
  { name: "greataxe", meleeDamage: 6, type: "martial weapon" },
  {
    name: "greatsword",
    meleeDamage: 7,
    type: "martial weapon",
...
const rangedWeapons = [
  ...
  { name: "crossbow", meleeDamage: 4, type: "ranged weapon" },
];
...
class RandomCharacter {
  ...
  addItem(itemName, itemArray) {
    // edit to add amount param with a default of 1
    const itemIndex = itemArray.findIndex((item) => item.name === itemName);

    this.items.push(itemArray[itemIndex]);
  }
